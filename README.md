...
[![Status](https://img.shields.io/badge/status-v1.0.15-brightgreen)](https://github.com/pmilet/ai-ddd-mainframe-modernization-patterns/releases)
...
| Format | Description |
|--------|-------------|
| 📄 [**PDF**](https://github.com/pmilet/ai-ddd-mainframe-modernization-patterns/releases/download/v1.0.15/Agentic.Domain-Driven.Mainframe.Modernization.pdf) | Full catalog, print-friendly |
| 📱 [**EPUB**](https://github.com/pmilet/ai-ddd-mainframe-modernization-patterns/releases/download/v1.0.15/Agentic.Domain-Driven.Mainframe.Modernization.epub) | E-reader format (Kindle, Kobo, Apple Books) |
